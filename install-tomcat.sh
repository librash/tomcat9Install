...
cd /usr/local/
wget http://ftp.unicamp.br/pub/apache/tomcat/tomcat-9/v9.0.75/bin/apache-tomcat-9.0.75.tar.gz  # change the url with reruired ver form http://ftp.unicamp.br/pub/apache/tomcat/tomcat-9
tar -xvf apache-tomcat-9.0.75.tar.gz								# should be as per the tar filename from wget 
mv apache-tomcat-9.0.75/* /usr/local/tomcat							# mv (folder name as per the wget tar file , remeber to remove .tar.gz herw ), if gives error , crate "tomcat" folder at /usr/local/
